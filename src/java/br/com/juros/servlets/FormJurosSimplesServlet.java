 ...
 * @author jeffersoncn
 */
public class FormJurosSimplesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print(" <head> ");
            out.print("     <title>Juros Simples</title> ");
            ...
            out.print("         </a> ");
            out.print("         <a href='juros-simples' class='active item'> ");
            ...
            out.print("                     <p>O regime de juros será simples quando o percentual de juros incidir apenas sobre o valor principal. Sobre ");
            out.print("                         os juros gerados a cada período não incidirão novos juros. Valor Principal ou simplesmente principal ");
            out.print("                         é o valor inicial emprestado ou aplicado, antes de somarmos os juros. </p> ");
            out.print("                 </div> ");
            out.print("             </div> ");
            out.print("         </div> ");
            out.print("     </div> ");
