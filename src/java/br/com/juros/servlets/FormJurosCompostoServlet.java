...
public class FormJurosCompostoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print("         <a href='home.html' class='item'> ");
            out.print("             <i class='home left icon'></i> Home ");
            out.print("         </a> ");
            out.print("         <a href='juros-simples.html' class='item'> ");
            out.print("             <i class='percent left icon'></i> Juros Simples ");
            out.print("         </a> ");
            out.print("         <a href='juros-composto.html' class='active item'> ");
            out.print("             <i class='signal left icon'></i> Juros Composto ");
            out.print("         </a> ");
            out.print("     </div> ");
            out.print("     <div class='pusher'> ");
            out.print("         <div class='ui dimmer'> ");
            out.print("             <div class='ui text loader'>Calculando</div> ");
            out.print("         </div> ");
            ...
            out.print("                     <form action='resultado-composto.html' class='ui large form'> ");
